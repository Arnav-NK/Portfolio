...
const scrollRight = () => {
  ...
  // If at (or very near) the last card → go back to first
  ...
  return (
    <>
      <div className='project'>
        ...
        <div style={{ position: 'relative', width: '100%', margin: '-10px auto' }}>

          {/* Slider */}
          <div className="project-slider-container" ref={sliderRef}>
            <div className="projects_section">
              ...
              {/* --------------------- PROJECT 2: Stop Watch Extension --------------------- */}
              <div className="project-card-item">
                <a
